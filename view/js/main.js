...
//variables globales caroussel qualities
...
window.onload = () =>{
   ...
   */
    ...
    connexion = document.querySelector('.hide_connexion');
    
    connexion.addEventListener('click', connexionAppear);
          
    connexion.addEventListener("click",connexionAppear);
    window.addEventListener("scroll", connexionDesappear);
          
    connexion.addEventListener("mouseover",connexionAppear);
    connexion.addEventListener("mouseout", connexionDesappear);              
          
    appear = connexion.dataset.appear;
    ...
    const carousel = document.querySelector(".qualities");
   ...
   /**
    ...
    arrowTop = document.querySelector('.logo-fleche');
 ...
 */
    ...
    function connexionAppear(){
        connexion.style.translate = "350px";
        connexion.style.transition = appear+"ms ease-in-out";
    }

    function connexionDesappear(){
        connexion.style.translate = "0px";
        connexion.style.transition = appear+"ms ease-in-out";
